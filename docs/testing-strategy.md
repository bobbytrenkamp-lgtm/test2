...
| Equity distributions stop at the sale date | `packages/calculation-engine/src/waterfall.test.ts` | 3 | No |
...
**198 browser tests in total**, for 1312 across the whole repository.
