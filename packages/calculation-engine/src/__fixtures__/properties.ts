...
export function singleTenantIndustrial(): ModelInput {
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 60, fiscalYearStartMonth: 1, proration: 'actual_days' },
    property: {
      id: 'P-IND',
...
export function multiTenantOffice(): ModelInput {
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 84, fiscalYearStartMonth: 1, proration: 'actual_days' },
    property: { id: 'P-OFF', name: 'Harborview Tower', propertyType: 'office', rentableArea: '60000' },
    growthCurves: [
      { id: 'CPI', name: 'Inflation', defaultRate: '0.025' },
      { id: 'MKT', name: 'Market rent growth', defaultRate: '0.03' },
    ],
    spaces: [
      { id: 'S-10', code: 'Suite 1000', floor: '10', area: '25000', spaceType: 'office', marketLeasingProfileId: 'MLA-OFFICE' },
      { id: 'S-11', code: 'Suite 1100', floor: '11', area: '20000', spaceType: 'office', marketLeasingProfileId: 'MLA-OFFICE' },
      { id: 'S-12', code: 'Suite 1200', floor: '12', area: '15000', spaceType: 'office', marketLeasingProfileId: 'MLA-OFFICE' },
    ],
    tenants: [
    ...
    leases: [
      {
        ...
        baseRent: '32.00',
        baseRentBasis: 'per_area_per_year',
        escalation: { type: 'fixed_percent', rate: '0.03', frequencyMonths: 12, firstEscalationDate: '2026-07-01' },
      ...
      },
      {
        ...
        baseRent: '30.00',
        baseRentBasis: 'per_area_per_year',
        escalation: { type: 'fixed_amount', amount: '0.75', frequencyMonths: 12, firstEscalationDate: '2027-01-01' },
    ...
    expenses: [
      { id: 'E-TAX', name: 'Property taxes', category: 'taxes', method: 'per_area_per_year', amount: '4.50', growthCurveId: 'CPI', recoverableShare: '1', variableShare: '0' },
      { id: 'E-INS', name: 'Insurance', category: 'insurance', method: 'per_area_per_year', amount: '0.85', growthCurveId: 'CPI', recoverableShare: '1', variableShare: '0' },
      { id: 'E-CAM', name: 'Common area maintenance', category: 'cam', method: 'per_area_per_year', amount: '3.20', growthCurveId: 'CPI', recoverableShare: '1', variableShare: '0.4' },
      { id: 'E-UTL', name: 'Utilities', category: 'utilities', method: 'per_area_per_year', amount: '2.10', growthCurveId: 'CPI', recoverableShare: '1', variableShare: '0.7' },
      { id: 'E-MGT', name: 'Management fee', category: 'management', method: 'percent_of_effective_gross_revenue', amount: '0.03', recoverableShare: '1', variableShare: '0' },
      { id: 'E-GA', name: 'General and administrative', category: 'admin', method: 'per_area_per_year', amount: '0.60', growthCurveId: 'CPI', recoverableShare: '0', variableShare: '0' },
    ],
    vacancy: { generalVacancyRate: '0.05', netAgainstModelledVacancy: true, creditLossRate: '0.005' },
    capital: [
      { id: 'C-RES', name: 'Replacement reserve', category: 'replacement_reserve', method: 'per_area_per_year', amount: '0.25', growthCurveId: 'CPI' },
    ],
    valuation: {
      discountRate: '0.0775',
      discountingConvention: 'end_of_period',
...
export function groceryAnchoredRetail(): ModelInput {
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 60, fiscalYearStartMonth: 1, proration: 'actual_days' },
    property: { id: 'P-RET', name: 'Willow Creek Commons', propertyType: 'retail', rentableArea: '85000' },
    growthCurves: [
      { id: 'CPI', name: 'Inflation', defaultRate: '0.025' },
    ...
    leases: [
      ...
      },
      {
        ...
        baseRent: '22.00',
        baseRentBasis: 'per_area_per_year',
        escalation: { type: 'fixed_percent', rate: '0.025', frequencyMonths: 12, firstEscalationDate: '2027-03-01' },
      ...
      },
      {
        ...
        baseRent: '26.00',
        baseRentBasis: 'per_area_per_year',
        freeRent: [{ startDate: '2026-01-01', months: 3, abatementShare: '1', appliesTo: ['base_rent'] }],
    ...
    expenses: [
      { id: 'E-TAX', name: 'Property taxes', category: 'taxes', method: 'per_area_per_year', amount: '2.20', growthCurveId: 'CPI', recoverableShare: '1' },
      { id: 'E-CAM', name: 'Common area maintenance', category: 'cam', method: 'per_area_per_year', amount: '1.80', growthCurveId: 'CPI', recoverableShare: '1', variableShare: '0.3' },
      { id: 'E-INS', name: 'Insurance', category: 'insurance', method: 'per_area_per_year', amount: '0.45', growthCurveId: 'CPI', recoverableShare: '1' },
      { id: 'E-MGT', name: 'Management fee', category: 'management', method: 'percent_of_effective_gross_revenue', amount: '0.04', recoverableShare: '0' },
    ],
...
export function multifamily(): ModelInput {
  return buildModel({
    ...
    spaces: [{ id: 'S-ALL', code: 'Residential units', area: '180000', unitCount: 200, spaceType: 'residential' }],
    ...
    otherRevenue: [
      { id: 'R-PARK', name: 'Parking', category: 'parking', method: 'per_unit_per_month', amount: '65', growthCurveId: 'CPI', varyWithOccupancy: true },
      { id: 'R-PET', name: 'Pet fees', category: 'other', method: 'per_unit_per_month', amount: '18', growthCurveId: 'CPI', varyWithOccupancy: true },
      { id: 'R-UTIL', name: 'Utility reimbursement', category: 'utility_reimbursement', method: 'per_unit_per_month', amount: '55', growthCurveId: 'CPI', varyWithOccupancy: true },
    ],
    expenses: [
      { id: 'E-TAX', name: 'Property taxes', category: 'taxes', method: 'per_unit_per_year', amount: '2400', growthCurveId: 'CPI' },
      { id: 'E-PAY', name: 'Payroll', category: 'payroll', method: 'per_unit_per_year', amount: '1150', growthCurveId: 'CPI', variableShare: '0.2' },
      { id: 'E-RM', name: 'Repairs and maintenance', category: 'repairs', method: 'per_unit_per_year', amount: '950', growthCurveId: 'CPI', variableShare: '0.5' },
      { id: 'E-UTL', name: 'Utilities', category: 'utilities', method: 'per_unit_per_year', amount: '780', growthCurveId: 'CPI', variableShare: '0.6' },
      { id: 'E-MKT', name: 'Marketing', category: 'marketing', method: 'per_unit_per_year', amount: '210', growthCurveId: 'CPI' },
      { id: 'E-MGT', name: 'Management fee', category: 'management', method: 'percent_of_effective_gross_revenue', amount: '0.03' },
    ],
    vacancy: { generalVacancyRate: '0.055', netAgainstModelledVacancy: true, creditLossRate: '0.005' },
    capital: [
      { id: 'C-RES', name: 'Replacement reserve', category: 'replacement_reserve', method: 'per_unit_per_year', amount: '300', growthCurveId: 'CPI' },
    ],
    valuation: {
      discountRate: '0.07',
...
export function developmentProject(): ModelInput {
  ...
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 60, fiscalYearStartMonth: 1, proration: 'actual_days' },
    property: { id: 'P-DEV', name: 'Ridgeline Commerce Park Phase I', propertyType: 'industrial', rentableArea: '150000' },
    growthCurves: [
      { id: 'MKT', name: 'Market rent growth', defaultRate: '0.03' },
      {
        id: 'SOFR',
    ...
    spaces: [{ id: 'S-DEV', code: 'Building 1', area: '150000', spaceType: 'warehouse', marketLeasingProfileId: 'MLA-DEV' }],
    ...
    leases: [
      {
        ...
        freeRent: [{ startDate: '2027-11-01', months: 6, abatementShare: '1', appliesTo: ['base_rent'] }],
    ...
    expenses: [
      { id: 'E-TAX', name: 'Property taxes', category: 'taxes', method: 'per_area_per_year', amount: '0.65', recoverableShare: '1' },
      { id: 'E-INS', name: 'Insurance', category: 'insurance', method: 'per_area_per_year', amount: '0.18', recoverableShare: '1' },
      { id: 'E-CAM', name: 'Common area maintenance', category: 'cam', method: 'per_area_per_year', amount: '0.42', recoverableShare: '1', variableShare: '0.3' },
    ],
    capital: [
      { id: 'C-LAND', name: 'Land acquisition', category: 'development_hard_cost', method: 'one_time', amount: '4500000', startDate: '2026-01-01' },
      { id: 'C-HARD', name: 'Hard costs', category: 'development_hard_cost', method: 'custom_monthly_schedule', monthlySchedule: drawSchedule },
      { id: 'C-SOFT', name: 'Soft costs and fees', category: 'development_soft_cost', method: 'one_time', amount: '3200000', startDate: '2026-04-01' },
    ],
    debt: [
      {
        id: 'D-CONST',
...
export function mixedUse(): ModelInput {
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 72, fiscalYearStartMonth: 1, proration: 'actual_days' },
    ...
    spaces: [
      { id: 'S-RET', code: 'Ground floor retail', floor: '1', area: '12000', spaceType: 'retail', marketLeasingProfileId: 'MLA-RET' },
      { id: 'S-OFF', code: 'Floors 2-5 office', area: '58000', spaceType: 'office', marketLeasingProfileId: 'MLA-OFF' },
    ],
    tenants: [
    ...
    leases: [
      {
        ...
        baseRent: '38.00',
        baseRentBasis: 'per_area_per_year',
        escalation: { type: 'fixed_percent', rate: '0.03', frequencyMonths: 12, firstEscalationDate: '2026-06-01' },
        recovery: { method: 'triple_net' },
      ...
      },
      {
        ...
        baseRent: '29.50',
        baseRentBasis: 'per_area_per_year',
        escalation: { type: 'fixed_percent', rate: '0.025', frequencyMonths: 12, firstEscalationDate: '2026-09-01' },
        recovery: { method: 'base_year', baseYear: 2026 },
        marketLeasingProfileId: 'MLA-OFF',
      },
    ],
    marketLeasingProfiles: [
      { id: 'MLA-RET', name: 'Foundry retail', marketRent: '40.00', marketRentBasis: 'per_area_per_year', renewalProbability: '0.6', downtimeMonths: 9, newTiPerArea: '60.00', renewalTiPerArea: '15.00', newLcPercent: '0.05', renewalLcPercent: '0.025', recovery: { method: 'triple_net' }, precedence: 10 },
      { id: 'MLA-OFF', name: 'Foundry office', marketRent: '31.00', marketRentBasis: 'per_area_per_year', renewalProbability: '0.7', downtimeMonths: 6, newTiPerArea: '50.00', renewalTiPerArea: '12.00', newLcPercent: '0.04', renewalLcPercent: '0.02', recovery: { method: 'base_year' }, precedence: 10 },
    ],
    expenses: [
      { id: 'E-TAX', name: 'Property taxes', category: 'taxes', method: 'per_area_per_year', amount: '5.10', growthCurveId: 'CPI', recoverableShare: '1' },
      { id: 'E-OPS', name: 'Building operations', category: 'cam', method: 'per_area_per_year', amount: '6.40', growthCurveId: 'CPI', recoverableShare: '1', variableShare: '0.35' },
      { id: 'E-MGT', name: 'Management fee', category: 'management', method: 'percent_of_effective_gross_revenue', amount: '0.03' },
    ],
...
export function baseYearRecovery(): ModelInput {
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 48, fiscalYearStartMonth: 1, proration: 'actual_days' },
    ...
    expenses: [
      { id: 'E1', name: 'Operating expenses', category: 'cam', method: 'fixed_annual', amount: '500000', growthCurveId: 'G10', recoverableShare: '1', variableShare: '0' },
    ],
    valuation: { discountRate: '0.08', terminalCapRate: '0.07', terminalNoiBasis: 'trailing_12', saleMonth: 48 },
  });
}
...
export function expenseStopRecovery(): ModelInput {
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 36, fiscalYearStartMonth: 1, proration: 'actual_days' },
    property: { id: 'P-ES', name: 'Expense-stop test', propertyType: 'office', rentableArea: '100000' },
    spaces: [
    ...
    expenses: [
      { id: 'E1', name: 'Operating expenses', category: 'cam', method: 'per_area_per_year', amount: '10.00', recoverableShare: '1', variableShare: '0' },
    ],
    valuation: { discountRate: '0.08', terminalCapRate: '0.07', terminalNoiBasis: 'trailing_12', saleMonth: 36 },
  });
}
...
export function percentageRentProperty(): ModelInput {
  return buildModel({
    ...
    forecast: { startDate: '2026-01-01', months: 24, fiscalYearStartMonth: 1, proration: 'actual_days' },
    property: { id: 'P-PR', name: 'Percentage-rent test', propertyType: 'retail', rentableArea: '20000' },
    ...
    valuation: { discountRate: '0.08', terminalCapRate: '0.07', terminalNoiBasis: 'trailing_12', saleMonth: 24 },
  });
}
