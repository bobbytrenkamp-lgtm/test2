  ...
  build(summary, context) {
    ...
    return {
      ...
      footnotes: [
        ...
        'Recallable distributions, fund-level carried interest and management fee mechanics are not modelled. Where a partnership agreement provides for them, this statement will differ from one prepared under it.',
      ],
    };
  },
};
